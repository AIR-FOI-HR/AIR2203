...
import hr.foi.air2203.databinding.ActivityEditemailBinding
...
class EditEmailActivity : AppCompatActivity(), EditListener, KodeinAware {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding: ActivityEditemailBinding = DataBindingUtil.setContentView(this, R.layout.activity_editemail)
