...
import hr.foi.air2203.databinding.ActivityEditusernameBinding
import hr.foi.air2203.utils.startProfilePageActivity
import org.kodein.di.KodeinAware
import org.kodein.di.android.kodein
import org.kodein.di.generic.instance

class EditUsernameActivity : AppCompatActivity(), EditListener, KodeinAware {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding: ActivityEditusernameBinding = DataBindingUtil.setContentView(this, R.layout.activity_editusername)
